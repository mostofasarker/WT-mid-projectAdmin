...
$name = $username = $password = $email = $phone = $dob = $address = $gender = $usertype = "";
$nameErr = $usernameErr = $passwordErr = $emailErr =$phoneErr = $dobErr = $addressErr = $genderErr = $usertypeErr = "";
...
if (isset($_POST["sign_up"])) //sign_up $_SERVER['REQUEST_METHOD']=='POST'
{
    ...
    if (!$hasError) {
        $rs = insertUser($id, $username, $password, $gender, $email, $phone, $dob, $address, $usertype);
        if ($rs === true) {
...
function insertUser($id, $username, $password, $gender, $email, $phone, $dob, $address, $usertype)
{
    $query = "insert into users values ($id,'$username','$password','$gender','$email','$phone','$dob', '$address','$usertype');";
